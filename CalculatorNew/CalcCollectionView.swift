...
class CalcCollectionView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UpdateResult  {
...
//        let viewModel = CalcViewModel.cellViewModels[indexPath.row]
//
